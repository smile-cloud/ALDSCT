...
TXT_path = r'D:\Code\Python\YOLOv8-Tou\data\labels' # 原TXT文件
Image_path = r'D:\Code\Python\YOLOv8-Tou\data\images' # 原图片文件
dataset_path = r'D:\Code\Python\YOLOv8-Tou\data\custom_dataset' # 保存的目标位置
